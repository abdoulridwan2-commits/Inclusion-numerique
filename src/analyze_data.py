...
# IMPORTANT : population_worldpop.tif est un raster de DENSITÉ (hab/km²),
# pas un raster de comptage. On ne peut donc pas sommer les pixels
# directement (stats=["sum"]) — cela additionnerait des densités entre
# elles, ce qui n'a pas de sens physique et surestime la population
# d'environ 18% (vérifié : total obtenu 9 568 508 vs recensement RGPH-5
# réel 8 095 498). La population est calculée correctement plus bas
# comme densité moyenne x superficie de la préfecture.
...
print(
    "Densité moyenne calculée pour les 37 préfectures."
)
...
# Population = densité moyenne (hab/km²) x superficie (km²).
# C'est le calcul correct pour un raster de densité (voir note plus haut).
...
print(
    "Population totale estimée (densité x superficie) : "
