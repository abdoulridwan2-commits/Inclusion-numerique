...
if opencellid.exists():
    try:
        # Le fichier OpenCelliD brut n'a pas de ligne d'en-tête :
        # sans header=None, pandas prend la 1ère antenne comme titres
        # de colonnes et en perd le compte (32 au lieu de 33).
        df = pd.read_csv(opencellid, compression="gzip", header=None)
